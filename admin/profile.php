        ...
        if(isset($_POST["pass_update"])){
            ...
            if(mysqli_num_rows($check) > 0){
                if($pass_new1 == $pass_new2){
                    ...
                    $sql = "UPDATE tb_users SET password = '$hash_pass_new' WHERE username = '$user'";
                    $result = mysqli_query($conn, $sql);
                    if($result){
                        $_SESSION['alert'] = array(
                            "uname" => $_SESSION['uname'],
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <div class="row m-0">
                                <div class="col-12">
                                    <h5 class="m-0 font-weight-bold text-primary">บัญชีของฉัน</h5>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-md-6 col-sm">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <a class="link" style="cursor:pointer" data-toggle='modal' data-target='#ChangePasswordModal'>เปลี่ยนรหัสผ่าน</a>
                                        </div>
                                    </div>
                                    <form class="row g-2" method="POST">
                                        ...
                                        <div class="col-md-12">
                                            <div class="d-grid gap-2 my-3">
                                                <a id="btn_edit" class="btn btn-dark btn-block">แก้ไข</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
